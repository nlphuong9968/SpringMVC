...
<!-- Bootstrap Core CSS -->
<link rel="stylesheet" href= '<c:url value="/resources/bootstrap-3.4.1/css/bootstrap.min.css" />' />
<!-- Custom CSS -->
                           ...
                           <div class="menu">
									<ul id="menu" >
										<li><a href="index.html"><i class="fa fa-tachometer"></i> <span>Dashboard</span><div class="clearfix"></div></a></li>
										 ...
										 <li id="menu-academico" ><a href='<c:url value="/addProduct" />'><i class="fa fa-folder-open"></i><span>Product</span><div class="clearfix"></div></a></li>
